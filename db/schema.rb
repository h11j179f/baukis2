...
ActiveRecord::Schema.define(version: 2020_09_01_215404) do
  ...
  create_table "allowed_sources", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["namespace", "octet1", "octet2", "octet3", "octet4"], name: "index_allowed_source_on_namespace_and_octets", unique: true
  end
